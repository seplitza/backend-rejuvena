...
router.post('/init-prizes-temp', async (req: Request, res: Response) => {
  try {
    ...
    const prizes = [
      { name: 'Бесплатный доступ к любому из продвинутых курсов на 1 месяц', description: 'Получите доступ к любому продвинутому курсу на 30 дней', type: 'freeProduct', value: 0, probability: 5, icon: '🎓', validityDays: 30, isActive: true },
      { name: 'Подарок: крем для тела с медным пептидом', description: 'Крем для тела с медным пептидом в подарок', type: 'freeProduct', value: 0, probability: 8, icon: '🎁', validityDays: 30, isActive: true },
      { name: 'Бесплатное продление модуля «+ на губы и челюсть» на 1 месяц', description: 'Продление доступа к модулю на 30 дней', type: 'freeProduct', value: 0, probability: 7, icon: '💋', validityDays: 30, isActive: true },
      { name: 'Подарочный набор: сыворотка + крем с медным пептидом', description: 'Набор из сыворотки и крема с медным пептидом', type: 'freeProduct', value: 0, probability: 6, icon: '🎁', validityDays: 30, isActive: true },
      { name: 'Бесплатное участие в следующем марафоне Сеплица', description: 'Участие в следующем марафоне бесплатно', type: 'freeProduct', value: 0, probability: 9, icon: '🏃', validityDays: 60, isActive: true },
      ...
      { name: 'Подарок: любая из 3-х сывороток на выбор', description: 'Выберите любую сыворотку из трёх', type: 'freeProduct', value: 0, probability: 9, icon: '💧', validityDays: 30, isActive: true },
      { name: 'Подарок: любой БАД на выбор', description: 'Выберите любую биодобавку', type: 'freeProduct', value: 0, probability: 8, icon: '💊', validityDays: 30, isActive: true },
      ...
      { name: 'Бесплатная доставка на следующий заказ', description: 'Доставка вашего следующего заказа бесплатно', type: 'freeShipping', value: 0, probability: 10, icon: '📦', validityDays: 30, isActive: true },
