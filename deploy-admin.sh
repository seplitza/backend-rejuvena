...
echo ""
echo "📍 Admin panel URL: https://backend.seplitza.ru/admin"
echo ""
echo "Nginx should already be configured to serve the admin panel from /var/www/rejuvena-backend/admin-panel"
