...
exports.MarketplaceParserService = void 0;
...
class MarketplaceParserService {
     ...
     */
    async parseWildberries(articleWB) {
        try {
    ...
    async parseOzon(skuOzon) {
        try {
            ...
            if (response.data?.widgetStates) {
                ...
                const priceWidget = Object.values(response.data.widgetStates).find((widget) => widget?.price || widget?.finalPrice);
                if (priceWidget) {
...
exports.MarketplaceParserService = MarketplaceParserService;
exports.default = new MarketplaceParserService();
